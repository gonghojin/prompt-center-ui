      ...
      if (isFavorite) {
        ...
        setFavoritePrompts((prevFavorites) => [
          ...prevFavorites,
          {
            ...
            author: "나",
            favoriteCount: promptToToggle.favoriteCount,
            viewCount: promptToToggle.viewCount,
                ...
                <TabsContent value="favorites" className="space-y-4">
                  {favoritePrompts.map((prompt) => (
                      <FavoritePromptCard
                          ...
                          prompt={prompt}
                          onRemoveFavorite={(id) => {
                            const promptToRemove = myPrompts.find((p) => p.id === id)
                            if (promptToRemove) {
                              setFavoritePrompts((prevFavorites) =>
                                  prevFavorites.filter((favPrompt) => favPrompt.id !== id),
                              )
                              setRecentActivity((prevActivity) => [
                                ...prevActivity,
                                {
